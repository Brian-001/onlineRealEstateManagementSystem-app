...
<div class="flex flex-wrap justify-start text-black h-auto p-5 gap-6">
      ...
      <div class="pcard p-2 bg-white-200 w-56 h-56 shadow-md">
        <img src="/pimages/garden5.jpg" alt="" class="object-cover object-center overflow-hidden">
        <div class="grid grid-rows-2 grid-flow-col gap-2 text-xs overflow-hidden">
            <p>Name</p>
            <p>location</p>
            <p>Location</p>
      ...
      <div class="pcard p-2 bg-white-200 w-56 h-56 shadow-md">
        <img src="/pimages/garden6.jpg" alt="" class="object-cover object-center overflow-hidden">
        <div class="grid grid-rows-2 grid-flow-col gap-2 text-xs overflow-hidden">
            <p>Name</p>
            <p>location</p>
            <p>Location</p>
      ...
      <div class="pcard p-2 bg-white-200 w-56 h-56 shadow-md">
        <img src="/pimages/garden7.jpg" alt="" class="object-cover object-center overflow-hidden">
        <div class="grid grid-rows-2 grid-flow-col gap-2 text-xs overflow-hidden">
            <p>Name</p>
            <p>location</p>
            <p>Location</p>
      ...
      <div class="pcard p-2 bg-white-200 w-56 h-56 shadow-md">
        <img src="/pimages/garden8.jpg" alt="" class="object-cover object-center overflow-hidden">
        <div class="grid grid-rows-2 grid-flow-col gap-2 text-xs overflow-hidden">
            <p>Name</p>
            <p>location</p>
            <p>Location</p>

...
<body>
    ...
    <div class="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
        <div class="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
            <img class="w-full" alt="image of a girl posing" src="{{ asset($product->image) }}" />
        ...
        <div class="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
            ...
            <button
                class="dark:bg-gray dark:text-black-900  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-base flex items-center justify-center leading-none text-white bg-gray-800 w-full py-4 hover:bg-gray-700 focus:outline-none">
            ...
            <div>
                <p class="xl:pr-48 text-base lg:leading-tight leading-normal text-black-600 dark:text-black-300 mt-7">It
                    is a long established fact that a reader will be distracted by thereadable content of a page when
                    looking at its layout. The point of usingLorem Ipsum is that it has a more-or-less normal
                    distribution of letters.</p>
                <p class="text-base leading-4 mt-7 text-black-600 dark:text-black-300">Product Code: 8BN321AF2IF0NYA</p>
                <p class="text-base leading-4 mt-4 text-black-600 dark:text-black-300"><div class="2">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</div></p>
                <!--
                ...
                <p class="md:w-96 text-base leading-normal text-black-600 dark:text-black-300 mt-4">Composition: 100%
            ...
            <div>
                <div class="border-t border-b py-4 mt-7 border-gray-200">
                    ...
                    <div class="hidden pt-4 text-base leading-normal pr-12 mt-4 text-black-600 dark:text-black-300"
                        id="sect">You will be responsible for paying for your own shipping costs for returning your
                        item. Shipping costs are nonrefundable</div>
                </div>
            </div>
            <div>

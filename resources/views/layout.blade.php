        ...
        <div class="flex flex-col md:flex-row bg-blue-100 text-gray-100 py-4 rounded-xl">
            ...
            <div class="sidebar-content px-4 py-6">
                <ul class="flex flex-col w-full">
                    ...
                    <li class="my-px">
                        <a href="{{ route('home.stall') }}" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            <span class="flex items-center justify-center text-lg text-gray-400">
                    ...
                    <li class="my-px">
                        <a href="{{ route('home.warehouse') }}" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            <span class="flex items-center justify-center text-lg text-gray-400">
                    ...
                    <li class="my-px">
                        <a href="{{ route('home.office') }}" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            <span class="flex items-center justify-center text-lg text-gray-400">
                    ...
                    <li class="my-px">
                        <a href="{{ route('home.land') }}" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            <span class="flex items-center justify-center text-lg text-gray-400">
                    ...
                    <li class="my-px">
                        <a href="{{ route('home.shouse') }}" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            <span class="flex items-center justify-center text-lg text-gray-400"> 
                    ...
                    <li class="my-px">
                        <a href="{{ route('home.restate') }}" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            <span class="flex items-center justify-center text-lg text-gray-400">
                    ...
                    <li class="my-px">
                        <a href="{{ route('home.apartment') }}" class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            <span class="flex items-center justify-center text-lg text-gray-400">
            ...
            <main class="main flex flex-col h-auto -ml-64 md:ml-0 w-5/6 transition-all duration-150 ease-in">
                ...
                <footer class="footer px-4 py-6">
                  <div class="footer-content">
                    <p class="text-sm text-gray-600 text-center">&copy;RealEstate 2022. All rights reserved. <a href="https://www.instagram.com/brian_kanyi/">by Brian Kanyi Karanja</a></p>

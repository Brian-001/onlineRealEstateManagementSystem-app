...
<body>
    ...
    <div class="flex flex-col md:flex-row bg-blue-100 text-gray-100 py-4 rounded-xl">
        <aside
            class="sidebar rounded-2xl w-1/6 md:shadow transform -translate-x-full
            ...
            <div class="sidebar-content px-4 py-6">
                <ul class="flex flex-col w-full">
                    <li class="my-px">
                        <a href="#"
                            class="flex flex-row items-center justify-center h-10 px-3 rounded-lg text-gray-700 bg-gray-100">

...
<body>
    ...
    <div class="flex  flex-col md:flex-row ">
        ...
        <div style="height: 100vh"
            class="w-1/6 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
            <div class="px-8">
                ...
                <ul class="mt-12">
                    ...
                    <li
                        ...
                        <a href="javascript:void(0)"
                            ...
                            <span class="text-sm ml-2">Customer List</span>
                        </a>
                    </li>
                    <li
                        class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
        ...
        <div
            class="flex flex-col h-auto -ml-64 md:ml-0 w-5/6 transition-all duration-150 ease-in w-5/6  bg-white rounded mt-4">

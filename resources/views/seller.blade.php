        ...
        <div class="h-screen flex items-center justify-center bg-white ">
            <form method="post" action="/products" enctype="multipart/form-data">
                ...
                <div class="my-6">
                    ...
                    <input type="text" class="border-solid border-2 border-black px-6 py-2 rounded-md" name="name"
                        id="name">
                    @error('item-name')
                ...
                <div class="my-6">
                    ...
                    <input type="number" class="border-solid border-2 border-black px-6 py-2 rounded-md" name="price"
                        id="price">
                    @error('price')
                        <div class="text-xs text-red-700 font-bold">
                            {{ $message }}
                ...
                <div class="my-6">
                    ...
                    <input type="text" class="border-solid border-2 border-black px-6 py-2 rounded-md" name="location"
                        id="location">
                    @error('location')
                        <div class="text-xs text-red-700 font-bold">
                            {{ $message }}
                ...
                <div class="my-6">
                    ...
                    <input type="text" class="border-solid border-2 border-black px-6 py-2 rounded-md" name="features"
                        id="features">
                    @error('features')
                        <div class="text-xs text-red-700 font-bold">
                            {{ $message }}
                ...
                <div class="my-6">
                    ...
                    <input type="file" accept=".gif,.jpg,.jpeg,.png,.doc,.docx"
                        class="border-solid border-2 border-black px-8 py-8 rounded-md" name="image" id="image">
                    @error('image')
                        <div class="text-xs text-red-700 font-bold">
                            {{ $message }}
                        </div>
